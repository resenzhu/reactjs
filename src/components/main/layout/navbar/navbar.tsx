...
import {Language} from './../../../../redux/reducers/main/layout.types';
import ReactCountryFlag from 'react-country-flag';
import brandImage from './../../../../assets/images/main/common/brand.webp';
...
const Navbar = (): JSX.Element =>
{
  ...
  const {language, viewport, setLanguage} = useLayout();
